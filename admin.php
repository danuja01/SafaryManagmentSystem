                  ...
                  if(mysqli_num_rows($result_set) == 1)
                    {
                      ...
                      $_SESSION['admin_id']=$customer['c_no'];
                      $_SESSION['l_name']=$customer['c_lname'];
                      $_SESSION['f_name']=$customer['c_fname'];
                      $_SESSION['p_no']=$customer['phone_no'];
                      $_SESSION['adrs']=$customer['address'];
                      $_SESSION['pss']=$customer['pass'];
                      $_SESSION['mail']=$customer['email'];
                        // check if the user is valid
                        //redirect to home
                         header('Location:http://localhost/CyloneSafari/adminCamping.php');
                    }
                   else
                   {
